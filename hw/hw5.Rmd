...
5. Intenta recrear la siguiente tabla con gtsummary:
...
6. OPCIONAL. Intenta crear un R Markdown file (devuelva un documento en formato html) que contenga las respuestas de esta tarea.