...
# La condición dentro de un if else statement nos devuelve un solo valor logico. En cambio, la condición dentro de la funcion ifelse nos devuelve vectores de valores logicos.
...
```{r, warning=TRUE, echo=FALSE, eval=FALSE}
